public class String2 {
  public static void main(String[] args){
      ...
      // hello -> he
      System.out.println(str.substring(0, 2)); // he only ( print同0,1) print到去2 (2唔PRINT)
      System.out.println(str.substring(2, 3)); // l only (end index -1). print到去3 ，相減係string length
      System.out.println(str.substring(0, 5)); // hello, 5-1完1先係4 (0,6)->error
      System.out.println(str.substring(3)); //lo 放一個參數，由果個位(3)開始print 到最後
      ...
      // contains()
      String s = "lo";
      System.out.println(str.contains(s)); //true, boolean true (hello contains  lo)
