public class String3 {
  public static void main(String[] abc) {
    ...
    // indexOf(int) or indexOf(char) //hello
    ...
    System.out.println(
        "The index of o in str, search from index 5 = " + str.indexOf('o', 5)); // -1 //本身default由 index 0開始
    System.out.println("The index of ll in str, search from index 3 = "
        + str.indexOf("ll", 3)); // -1 ,if 入 2index就有

    // lastIndexOf(int), the last ocurrence of the char in the string，搵到邊到停出最後
    String str3 = "hello";
    System.out.println(str3.lastIndexOf('l')); // 3 ,最後出現的position
    System.out.println(str3.lastIndexOf("ll", 9)); // 2
    System.out.println("test " + (str3.lastIndexOf('l', 2))); // 2 // 個2 index係指睇到去邊到，落集，所以入3index會出3，因為3位先係last occurence
                                                              // 入(1)index出 -1 因為搵唔到
    // replace
    ...
    System.out.println(newString); // hello Java! Java!
