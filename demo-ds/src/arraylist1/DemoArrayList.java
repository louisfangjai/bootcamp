...
public class DemoArrayList {
  public static void main(String[] args) {
    ...
    int original = numbers2.set(2, 100); // unbox , // [1,3,100,4,null]
    ...
    // indexOf/lastIndexOf/Input value, return個index,無就-1
    System.out.println(numbers2.indexOf(1000)); // -1
    System.out.println(numbers2.indexOf(3)); // 1

    System.out.println(numbers2.indexOf(4)); //2
