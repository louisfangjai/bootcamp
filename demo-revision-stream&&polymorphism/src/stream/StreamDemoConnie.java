...
public class StreamDemoConnie {
  ...
  // - - 1. flatMap()
  public static List<String> getAllAddresses1(List<Person2> persons) {
    return persons.stream()
  ...
  // - - 2. map()
  public static List<List<String>> getAllAddresses2(List<Person2> persons) {
    return persons.stream()
  ...
  // - - 3. loop (non-stream)
  public static List<String> getAllAddresses4(List<Person2> persons) {
    List<String> addresses = new ArrayList<>();
  ...
  public static List<String> getAllAddresses3(List<Person2> persons) {
    List<String> addresses = new ArrayList<>();
    for (Person2 p : persons) {
